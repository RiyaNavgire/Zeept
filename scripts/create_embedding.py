...
def select_embeddings_model(LLM_service,documents_texts):
    ...
    if LLM_service == "HuggingFace":        
        ...
        # documents_texts = [
        #     {"text1": "Generate an API token from your account settings", "source": "Website A"},
        #     {"text2": "Fine-tune the model or create your own custom prompt library for better results", "source": "Newspaper B"},
        #     {"text3": " Retrieve the response from the audio call","source":"Website ebay"},  # Missing source
        # ]
    ...
    if LLM_service == "Sentence":
        # Create and train sentence model (adjust parameters as needed)
    ...
    # print("\nLength of embedding list: " + str(len(embeddings_list)))
